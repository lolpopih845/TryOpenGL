...
public:
    explicit CameraObject(std::string& name, Engine::Transform transform = Engine::DEFAULT_TRANSFORM, Engine::GameObjectID parent = Engine::INVALID_ID,
                            glm::vec2 viewPortOffset  = glm::vec2(0.0f),glm::vec2 viewPortSize = glm::vec2(1.0f),
                            glm::vec3 up = glm::vec3(0.0f, 1.0f, 0.0f),
                          float yaw = -90,
                          float pitch = 0) : GameObject(name,transform,parent){
